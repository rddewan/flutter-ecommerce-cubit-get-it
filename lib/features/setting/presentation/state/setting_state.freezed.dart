...
class _$_SettingState implements _SettingState {
  const _$_SettingState({this.isLoading = false, this.isLoggedIn = false});
  ...
  @override
  String toString() {
    return 'SettingState(isLoading: $isLoading, isLoggedIn: $isLoggedIn)';
  }
...
abstract class _SettingState implements SettingState {
  const factory _SettingState({final bool isLoading, final bool isLoggedIn}) =
      _$_SettingState;
